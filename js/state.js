window.PhotoPaveState=(function(){
  ...
  const state={
    ...
    build: { version: "mvp-iter2.2.178-forms-bottom-visibility-hotfix",ts:new Date().toISOString(),preset:(RELEASE&&RELEASE.preset)||"legacy"},
    ...
    assets:{photoBitmap:null,photoW:0,photoH:0,textureCache:new Map(),lastLoadError:null,exportSafe:true,exportBlockedReason:null},
    // UX premium helpers
