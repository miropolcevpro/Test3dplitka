window.PhotoPaveState=(function(){
  ...
  function resetProjectState(targetState, options){
    ...
    st.scenePresets = st.scenePresets || {schemaVersion:1,enabled:false,status:"idle",source:"published",lastError:null,config:(st.api&&st.api.scenePresets)||{schemaVersion:1,contractVersion:1,enabled:false,manifestFile:"manifest.json",sceneFile:"scene.json",variantsIndexFile:"variants.json",variantsDir:"variants",publishedRoot:"preset-scenes/published",draftRoot:"preset-scenes/draft",publicReadMode:"published_only",adminReadMode:"draft_then_published",publicReadyMode:{enabled:true,autoBootstrap:true,autoOpenFirstScene:false,panelEnabled:true,maxSceneButtons:6,exactVariantOnly:true,keepUploadFlow:true},adminApi:{stage:"foundation",enabled:false,contextMode:"bootstrap_only",contextQueryParam:"ppAdmin",contextQueryValue:"1",storageKey:"pp_scene_presets_admin_token",sessionStorageKey:"pp_scene_presets_admin_token",allowTokenFromStorage:true,allowTokenFromQuery:false,allowTokenPersistence:false,authHeader:"Authorization",authScheme:"Bearer",authTokenHeader:"X-PhotoPave-Admin-Token",requireAuth:true,timeoutMs:25000,endpoints:{saveSceneDraft:"scene-presets/admin/draft/scene",saveVariantDraft:"scene-presets/admin/draft/variant",publishScene:"scene-presets/admin/publish/scene",publishVariant:"scene-presets/admin/publish/variant",uploadAsset:"scene-presets/admin/upload"},methods:{saveSceneDraft:"POST",saveVariantDraft:"POST",publishScene:"POST",publishVariant:"POST",uploadAsset:"POST"}}},manifest:null,activeSceneId:null,activeVariantKey:null,loadedAt:null,scenesById:{},scenesBySourceId:{},variantsByKey:{},variantsBySourceKey:{},manifestsBySource:{},lastResolved:null,requests:{manifestUrl:null,sceneUrl:null,variantsIndexUrl:null,variantUrl:null,resolution:null},variantIndicesBySceneSource:{},contract:null,lastSceneBase:null,lastVariantSnapshot:null,admin:{stage:"foundation",mode:"public",enabled:false,ready:false,lastError:null,tokenPresent:false,tokenSource:null,tokenMask:null,bootstrap:{enabled:false,tokenPresent:false,hasApiBase:false,hasGatewayBase:false},config:{stage:"foundation",enabled:false,contextMode:"bootstrap_only",contextQueryParam:"ppAdmin",contextQueryValue:"1",storageKey:"pp_scene_presets_admin_token",sessionStorageKey:"pp_scene_presets_admin_token",allowTokenFromStorage:true,allowTokenFromQuery:false,allowTokenPersistence:false,authHeader:"Authorization",authScheme:"Bearer",authTokenHeader:"X-PhotoPave-Admin-Token",requireAuth:true,timeoutMs:25000,endpoints:{saveSceneDraft:"scene-presets/admin/draft/scene",saveVariantDraft:"scene-presets/admin/draft/variant",publishScene:"scene-presets/admin/publish/scene",publishVariant:"scene-presets/admin/publish/variant",uploadAsset:"scene-presets/admin/upload"},methods:{saveSceneDraft:"POST",saveVariantDraft:"POST",publishScene:"POST",publishVariant:"POST",uploadAsset:"POST"}},lastAction:null,lastRequest:null,lastResponse:null}};
    return st;
  }

  const state={
    // IMPORTANT: version string is displayed in the footer and helps bust caches in iframe setups.
    build: { version: "mvp-iter2.2.187-admin-write-api-foundation",ts:new Date().toISOString(),preset:(RELEASE&&RELEASE.preset)||"legacy"},
    api:{gatewayBase:DEFAULT_GATEWAY,apiBase:DEFAULT_GATEWAY,storageBase:"https://storage.yandexcloud.net/webar3dtexture",allowApiPalette:!!(RELEASE&&RELEASE.assetDelivery&&RELEASE.assetDelivery.allowApiPaletteFallback),assetPolicy:(RELEASE&&RELEASE.assetDelivery)||null,config:null,scenePresets:(RELEASE&&RELEASE.scenePresets)||{schemaVersion:1,contractVersion:1,enabled:false,manifestFile:"manifest.json",sceneFile:"scene.json",variantsIndexFile:"variants.json",variantsDir:"variants",publishedRoot:"preset-scenes/published",draftRoot:"preset-scenes/draft",publicReadMode:"published_only",adminReadMode:"draft_then_published",publicReadyMode:{enabled:true,autoBootstrap:true,autoOpenFirstScene:false,panelEnabled:true,maxSceneButtons:6,exactVariantOnly:true,keepUploadFlow:true},adminApi:{stage:"foundation",enabled:false,contextMode:"bootstrap_only",contextQueryParam:"ppAdmin",contextQueryValue:"1",storageKey:"pp_scene_presets_admin_token",sessionStorageKey:"pp_scene_presets_admin_token",allowTokenFromStorage:true,allowTokenFromQuery:false,allowTokenPersistence:false,authHeader:"Authorization",authScheme:"Bearer",authTokenHeader:"X-PhotoPave-Admin-Token",requireAuth:true,timeoutMs:25000,endpoints:{saveSceneDraft:"scene-presets/admin/draft/scene",saveVariantDraft:"scene-presets/admin/draft/variant",publishScene:"scene-presets/admin/publish/scene",publishVariant:"scene-presets/admin/publish/variant",uploadAsset:"scene-presets/admin/upload"},methods:{saveSceneDraft:"POST",saveVariantDraft:"POST",publishScene:"POST",publishVariant:"POST",uploadAsset:"POST"}}}},
    ...
    release:{preset:(RELEASE&&RELEASE.preset)||"legacy",patch:(RELEASE&&RELEASE.patch)||null,inventory:(RELEASE&&RELEASE.inventory)||null,assetDelivery:(RELEASE&&RELEASE.assetDelivery)||null,capabilityMatrix:(RELEASE&&RELEASE.capabilityMatrix)||null,analytics:(RELEASE&&RELEASE.analytics)||null,simpleMode:(RELEASE&&RELEASE.simpleMode)||null,scenePresets:(RELEASE&&RELEASE.scenePresets)||null},
    floorPlane:{points:[],closed:false},
    zones:[],
    scenePresets:{schemaVersion:1,enabled:false,status:"idle",source:"published",lastError:null,config:{schemaVersion:1,contractVersion:1,enabled:false,manifestFile:"manifest.json",sceneFile:"scene.json",variantsIndexFile:"variants.json",variantsDir:"variants",publishedRoot:"preset-scenes/published",draftRoot:"preset-scenes/draft",publicReadMode:"published_only",adminReadMode:"draft_then_published",publicReadyMode:{enabled:true,autoBootstrap:true,autoOpenFirstScene:false,panelEnabled:true,maxSceneButtons:6,exactVariantOnly:true,keepUploadFlow:true},adminApi:{stage:"foundation",enabled:false,contextMode:"bootstrap_only",contextQueryParam:"ppAdmin",contextQueryValue:"1",storageKey:"pp_scene_presets_admin_token",sessionStorageKey:"pp_scene_presets_admin_token",allowTokenFromStorage:true,allowTokenFromQuery:false,allowTokenPersistence:false,authHeader:"Authorization",authScheme:"Bearer",authTokenHeader:"X-PhotoPave-Admin-Token",requireAuth:true,timeoutMs:25000,endpoints:{saveSceneDraft:"scene-presets/admin/draft/scene",saveVariantDraft:"scene-presets/admin/draft/variant",publishScene:"scene-presets/admin/publish/scene",publishVariant:"scene-presets/admin/publish/variant",uploadAsset:"scene-presets/admin/upload"},methods:{saveSceneDraft:"POST",saveVariantDraft:"POST",publishScene:"POST",publishVariant:"POST",uploadAsset:"POST"}}},manifest:null,activeSceneId:null,activeVariantKey:null,loadedAt:null,scenesById:{},scenesBySourceId:{},variantsByKey:{},variantsBySourceKey:{},manifestsBySource:{},lastResolved:null,requests:{manifestUrl:null,sceneUrl:null,variantsIndexUrl:null,variantUrl:null,resolution:null},variantIndicesBySceneSource:{},contract:null,lastSceneBase:null,lastVariantSnapshot:null,admin:{stage:"foundation",mode:"public",enabled:false,ready:false,lastError:null,tokenPresent:false,tokenSource:null,tokenMask:null,bootstrap:{enabled:false,tokenPresent:false,hasApiBase:false,hasGatewayBase:false},config:{stage:"foundation",enabled:false,contextMode:"bootstrap_only",contextQueryParam:"ppAdmin",contextQueryValue:"1",storageKey:"pp_scene_presets_admin_token",sessionStorageKey:"pp_scene_presets_admin_token",allowTokenFromStorage:true,allowTokenFromQuery:false,allowTokenPersistence:false,authHeader:"Authorization",authScheme:"Bearer",authTokenHeader:"X-PhotoPave-Admin-Token",requireAuth:true,timeoutMs:25000,endpoints:{saveSceneDraft:"scene-presets/admin/draft/scene",saveVariantDraft:"scene-presets/admin/draft/variant",publishScene:"scene-presets/admin/publish/scene",publishVariant:"scene-presets/admin/publish/variant",uploadAsset:"scene-presets/admin/upload"},methods:{saveSceneDraft:"POST",saveVariantDraft:"POST",publishScene:"POST",publishVariant:"POST",uploadAsset:"POST"}},lastAction:null,lastRequest:null,lastResponse:null}}
  };
